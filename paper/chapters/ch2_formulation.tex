...
\begin{figure}[tbp]
    ...
    \begin{tikzpicture}[scale=0.85,>=stealth]
        \fill[blue!5] (0,0) -- (5.2,0.42) -- (5.2,-0.42) -- cycle;
        \draw[->] (0,0) -- (5.6,0) node[right]{$r_y$（水平偏移）};
        \draw[->] (0,0) -- (0,3.4) node[above]{$r_x$（高度）};
        \draw[->] (0,0) -- (-1.45,-0.85) node[below left]{$r_z$};
        \draw[dashed,thick,blue!60] (0,0) -- (5.2,0.42);
        \draw[dashed,thick,blue!60] (0,0) -- (5.2,-0.42);
        \draw[->] (1.25,0) arc (0:5:1.25);
        \node[below right] at (1.55,0.1) {$90^\circ-\theta$};
        \filldraw[fill=orange!85,draw=orange!50!black] (3.45,0.2) circle (0.09);
        \node[above] at (3.45,0.28) {着陆器位置};
        \node[blue!60!black] at (4.4,-0.22) {安全走廊};
    \end{tikzpicture}
    \caption{下滑角约束的几何示意图}

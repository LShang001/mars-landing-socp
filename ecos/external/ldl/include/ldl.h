...
#define LDL_symbolic2 ldl_symbolic2 // 在proproc.c中调用
#define LDL_numeric2 ldl_numeric2   // 在kkt.c中调用
#define LDL_lsolve ldl_lsolve
#define LDL_lsolve2 ldl_lsolve2     // 在kkt.c中调用
#define LDL_dsolve ldl_dsolve       // 在kkt.c中调用
#define LDL_ltsolve ldl_ltsolve     // 在kkt.c中调用
